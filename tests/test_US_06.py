...
class Test_US_06:
    ...
    def test_loan_an_unavailable_camera(self):
        ...
        result2 = test_inventory.loanAsset(tested_camera.getAssetTag(), "01-01-2050")
    ...
    def test_loan_not_exists_camera(self):
        ...
        result = test_inventory.loanAsset("CC0016", "08-08-2030")
    ...
    def test_loan_camera_with_missing_details(self):
        ...
        result = test_inventory.loanAsset(tested_camera.getAssetTag(), "")
    ...
    def test_loan_an_unavailable_laptop(self):
        ...
        result2 = test_inventory.loanAsset(tested_laptop.getAssetTag(), "01-01-2050")
    ...
    def test_loan_not_exists_laptop(self):
        ...
        result = test_inventory.loanAsset("CB0016", "08-08-2030")
    ...
    def test_loan_laptop_with_missing_details(self):
        ...
        result = test_inventory.loanAsset(tested_laptop.getAssetTag(), "")
