...
class Test_US_01:
    ...
    def test_add_camera_missing_description(self):
        ...
        result = test_inventory.addAsset("Camera", "C002", "Test camera 2", 10)
        original_len = len(test_inventory.cameraList)
        result = test_inventory.addAsset("Camera", "C004", "", 10)
        assert result == False
        assert len(test_inventory.cameraList) == original_len
    ...
    def test_add_camera_incorrect_zoom(self):
        ...
        result = test_inventory.addAsset("Camera", "C002", "Test camera 2", 10)
        original_len = len(test_inventory.cameraList)
        result = test_inventory.addAsset("Camera", "C004", "Test camera 4", -1)
        assert result == False
        assert len(test_inventory.cameraList) == original_len
    ...
    def test_add_laptop_missing_description(self):
        ...
        result = test_inventory.addAsset("Laptop", "L002", "Test Laptop 2", "MACOS")
        original_len = len(test_inventory.laptopList)
        result = test_inventory.addAsset("Laptop", "L004", "", "WIN10")
        assert result == False
        assert len(test_inventory.laptopList) == original_len
    ...
    def test_add_laptop_missing_os(self):
        ...
        result = test_inventory.addAsset("Laptop", "L002", "Test Laptop 2", "MACOS")
        original_len = len(test_inventory.laptopList)
        result = test_inventory.addAsset("Laptop", "L004", "Test Laptop 4", "")
        assert result == False
        assert len(test_inventory.laptopList) == original_len
